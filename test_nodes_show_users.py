...
def test_nodes_show_users_parameter():
    """測試 nodes 命令的 show_users 參數"""
    
    start_date = "2025-08-11"
    end_date = "2025-08-17"
    
    print("🧪 測試 nodes 命令的 show_users 參數功能")
    print("=" * 50)
    
    # 測試 1: show_users=True (預設)
    print("\n📊 測試 1: 生成包含使用者資訊的節點趨勢圖...")
    try:
